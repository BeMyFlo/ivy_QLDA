            ...
            <div class="subcartegory-add-content">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <select name="sanpham_size" id="">
                        ...
                        <option value="M" class="size">Size M</option>
                        <option value="L" class="size">Size L</option>
                        <option value="XL" class="size">Size XL</option>
                        <option value="XXL" class="size">Size XXL</option>
                    </select>
