...
?>
        ...
        <h1 style="color:black">Các đơn hàng chưa hoàn thành:</h1>
                <br>
            <div class="table-content">
                ...
                ?>
                    <tr>
                        ...
                        <td> <a class ="btn-index button-stt " style ="color: white" href="?status=1&session_idA=<?php echo $result['session_idA'] ?>">Đã hoàn thành</a></td>
